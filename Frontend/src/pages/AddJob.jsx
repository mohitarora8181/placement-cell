...
const AddJob = () => {
  ...
  return (
    <div className='w-full mx-10 p-5 bg-gray-100 rounded-lg shadow-lg '>
      ...
      <form onSubmit={handleSubmit} className='space-y-4 flex flex-col items-center'>
        ...
        <button
          type='submit'
          className='w-fit px-10 py-3 bg-blue-500 text-white font-semibold rounded-md shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500'
        >
          Add Job
        </button>
      </form>
